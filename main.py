...
frontRight = Tyre(ts['front_right']['forwardPin'], ts['front_right']['backwardPin'], ts['front_right']['pwmPin'], car_speed)
frontLeft = Tyre(ts['front_left']['forwardPin'], ts['front_left']['backwardPin'], ts['front_left']['pwmPin'], car_speed)
backRight = Tyre(ts['back_right']['forwardPin'], ts['back_right']['backwardPin'], ts['back_right']['pwmPin'], car_speed)
backLeft = Tyre(ts['back_left']['forwardPin'], ts['back_left']['backwardPin'], ts['back_left']['pwmPin'], car_speed)
...
if camera_settings:
    ...
    if camera_settings_c:
        camera_c = Camera(csc['camera_type'], csc['camera_num'], csc['resolution'], csc['framerate'], csc['rotation'])
